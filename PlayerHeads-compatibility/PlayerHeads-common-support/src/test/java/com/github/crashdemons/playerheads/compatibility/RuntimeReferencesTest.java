...
public class RuntimeReferencesTest {
    ...
    public void testHasClass_valid() {
        ...
        assertEquals(true,RuntimeReferences.hasClass("org.shininet.bukkit.playerheads.events.FakeBlockBreakEvent"));
        assertEquals(true,RuntimeReferences.hasClass("com.github.crashdemons.playerheads.compatibility.common.Provider_common"));
    }
}
