 ...
 * 
 * This version of the class currently extends FakeBlockBreakEvent so that external plugin compatibility is not broken, 
 * but this is intended to be the new location of the class in the future.
 * 
