 ...
 */
public class CraftbukkitProfile extends CompatibleProfile {
    
    public CraftbukkitProfile(UUID id, String name){
        super(id,name);
    }
    
    public CraftbukkitProfile(Object internalProfile){
         super();
