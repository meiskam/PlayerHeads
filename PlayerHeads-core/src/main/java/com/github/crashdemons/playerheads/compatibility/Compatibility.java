...
public class Compatibility {
    ...
    private final static String FALLBACK_PROVIDER_TYPE="craftbukkit";
    ...
    private static CompatibilityProvider loadProviderByVersion(String type, int major,int minor) throws CompatibilityUnavailableException{
        ...
        try {
            ...
            Object potential_provider = ctor.newInstance();
            return (CompatibilityProvider) potential_provider;
