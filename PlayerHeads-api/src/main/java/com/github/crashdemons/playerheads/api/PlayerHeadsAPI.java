 ...
 * This interface defines each method that the PlayerHeads API provides.
...
public interface PlayerHeadsAPI {
     ...
     * Note: player-type heads will be untextured and have no set owner with this method.
     ...
     * Note: this method takes into full account plugin configuration settings, player's name, and preset item drop amount
