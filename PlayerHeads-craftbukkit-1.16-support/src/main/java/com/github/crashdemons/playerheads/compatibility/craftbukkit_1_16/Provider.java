...
import com.github.crashdemons.playerheads.compatibility.craftbukkit_1_13.Provider_craftbukkit;
...
public class Provider extends Provider_craftbukkit implements CompatibilityProvider {
    ...
    @Override public String getVersion(){ return "1.16"; }
  
    
    @Override
    protected boolean isLegacyCat(Entity e){//remove the necessity for this check in 1.14-1.16+
        return false;
    }
